...
if __name__ == '__main__':
    ...
    x2, y2 = readcsv("./log/PINN_ada_fun_loss.csv")
    plt.plot(x2, y2, 'green', label='PINN+ADF')

    x3, y3 = readcsv("./log/PINN_ada_loss.csv")
    plt.plot(x3, y3, color='blue', label='PINN+ADL')

    x4, y4 = readcsv("./log/PINN_ada_FunLoss_loss.csv")
    ...
    plt.show()
    # plt.savefig("./figures/loss_cmp.pdf")
    # plt.savefig("./figures/loss_cmp.eps")