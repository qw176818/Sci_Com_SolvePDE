...
def PDE(x, w, net):
    y = -1.0 / w / w * torch.tanh(w * x) + torch.tanh(w * x) * torch.tanh(w * x) * net(x)
...
#         plt.pause(0.1)
net.load_state_dict(torch.load('PINN-12-2-20-model'))
# np.savetxt("./log/PINN_loss_w12_2_20.csv", loss_sum, delimiter=',')
...
# plt.savefig("12-2-20.pdf")
# plt.savefig("12-2-20.eps")
...
# plt.xlim(-7.0, 7.0)
# plt.legend(fontsize = 13)
# plt.savefig("12-2-20_dxx.pdf")
# plt.savefig("12-2-20_dxx.eps")
