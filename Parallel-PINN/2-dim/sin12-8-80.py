...
# np.savetxt("./log/PINN_loss_w12_8_80.csv", loss_sum, delimiter=',')
...
plt.title("PINN w = 12, 8 layer 80 neural per layer")
plt.savefig("12-8-80.pdf")
plt.savefig("12-8-80.eps")
...
# plt.legend(fontsize = 13)
# plt.title("PINN w = 12, 8 layer 80 neural per layer")
# plt.savefig("12-8-80-dxx.pdf")
# plt.savefig("12-8-80-dxx.eps")
