...
#         plt.pause(0.1)
# torch.save(net.state_dict(), "sinw_12_4_40")
net.load_state_dict(torch.load("sinw_12_4_40"))
#     loss_sum.append([epoch + 1, loss.item()])
# np.savetxt("./log/PINN_loss_w_20_4_40.csv", loss_sum, delimiter=',')
...
plt.show()
# plt.savefig("sinw_PINN_12_4_40.pdf")
# plt.savefig("sinw_PINN_12_4_40.eps")
