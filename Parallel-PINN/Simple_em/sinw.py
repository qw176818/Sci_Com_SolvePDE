...
np.savetxt("./log/loss_w_1.csv", loss_sum, delimiter=',')
...
plt.plot(x0.detach().numpy(), y0.detach().numpy(), color='green', label = 'Exact')
plt.plot(x, y_ext, color = 'red', linestyle = '--', label = 'PINN')
...
plt.title("PINN w = 1, 2 layer 20 neural per layer")
plt.savefig("sinw_PINN_1_2_20.pdf")
plt.savefig("sinw_PINN_1_2_20.eps")